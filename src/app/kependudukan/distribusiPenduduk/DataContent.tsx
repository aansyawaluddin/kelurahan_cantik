...
// Contoh data distribusi penduduk
export const sampleDistribusiData = [
{
    tahun: 2024,
    rw: "RW 01",
    lakiLaki: 702,
...
const DataContent: React.FC = () => {
  ...
  const handleInput = () => {}; // Tidak membuka modal

  // Filter data sesuai filter
  const filteredData = sampleDistribusiData.filter((d) =>
